...
<table class="center">
    <tr>
        <td>Username:</td>
        <td><input placeholder="Type in your username" type="text" name="username" required></td>
    </tr>
    <tr>
        <td>Password</td>
        <td><input placeholder="Type in your password" type="password" name="password" required></td>
    </tr>
    <tr>
...
<p class="text-center" style="font-weight: bold;">New user? <br><a href="register.php">Please click here to sign up!</a></p>
